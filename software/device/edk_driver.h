...
typedef struct {
    ...
    volatile unsigned int DIGIT5;
    volatile unsigned int DIGIT6;
    volatile unsigned int DIGIT7;
    volatile unsigned int DIGIT8;
} SEVENSEG_TypeDef;
...
void seven_seg_write2(char dig5, char dig6, char dig7, char dig8);        //Write to 7-segment display
